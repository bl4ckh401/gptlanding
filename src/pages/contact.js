            ...
            <div className="bg-green-600 w-full">
                <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                    <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
                        ...
                        <span className="block">GPT Letters</span>
                    </h1>
                    <p className="mt-6 max-w-3xl text-xl text-gray-200">
                        We're always happy to hear from you! Fill out the form below or reach out to us via email or social media.
                    </p>
                </div>
            </div>
            ...
            <div className="bg-gray-900 w-full">
                <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
                    <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                        ...
                        <form className="mt-8 lg:mt-0 lg:col-span-2" action="#" method="POST">
